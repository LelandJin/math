...
const XMVECTORI32 g_XMNegativeZero      = {static_cast<int>(0x80000000), static_cast<int>(0x80000000), static_cast<int>(0x80000000), static_cast<int>(0x80000000)};
const XMVECTORI32 g_XMNegate3           = {static_cast<int>(0x80000000), static_cast<int>(0x80000000), static_cast<int>(0x80000000), static_cast<int>(0x00000000)};
const XMVECTORI32 g_XMMask3             = {static_cast<int>(0xFFFFFFFF), static_cast<int>(0xFFFFFFFF), static_cast<int>(0xFFFFFFFF), static_cast<int>(0x00000000)};
const XMVECTORI32 g_XMMaskX             = {static_cast<int>(0xFFFFFFFF), static_cast<int>(0x00000000), static_cast<int>(0x00000000), static_cast<int>(0x00000000)};
const XMVECTORI32 g_XMMaskY             = {static_cast<int>(0x00000000), static_cast<int>(0xFFFFFFFF), static_cast<int>(0x00000000), static_cast<int>(0x00000000)};
const XMVECTORI32 g_XMMaskZ             = {static_cast<int>(0x00000000), static_cast<int>(0x00000000), static_cast<int>(0xFFFFFFFF), static_cast<int>(0x00000000)};
const XMVECTORI32 g_XMMaskW             = {static_cast<int>(0x00000000), static_cast<int>(0x00000000), static_cast<int>(0x00000000), static_cast<int>(0xFFFFFFFF)};
...
const XMVECTORI32 g_XMInfinity          = {static_cast<int>(0x7F800000), static_cast<int>(0x7F800000), static_cast<int>(0x7F800000), static_cast<int>(0x7F800000)};
const XMVECTORI32 g_XMQNaN              = {static_cast<int>(0x7FC00000), static_cast<int>(0x7FC00000), static_cast<int>(0x7FC00000), static_cast<int>(0x7FC00000)};
const XMVECTORI32 g_XMQNaNTest          = {static_cast<int>(0x007FFFFF), static_cast<int>(0x007FFFFF), static_cast<int>(0x007FFFFF), static_cast<int>(0x007FFFFF)};
const XMVECTORI32 g_XMAbsMask           = {static_cast<int>(0x7FFFFFFF), static_cast<int>(0x7FFFFFFF), static_cast<int>(0x7FFFFFFF), static_cast<int>(0x7FFFFFFF)};
const XMVECTORI32 g_XMFltMin            = {static_cast<int>(0x00800000), static_cast<int>(0x00800000), static_cast<int>(0x00800000), static_cast<int>(0x00800000)};
const XMVECTORI32 g_XMFltMax            = {static_cast<int>(0x7F7FFFFF), static_cast<int>(0x7F7FFFFF), static_cast<int>(0x7F7FFFFF), static_cast<int>(0x7F7FFFFF)};
const XMVECTORI32 g_XMNegOneMask		= {static_cast<int>(0xFFFFFFFF), static_cast<int>(0xFFFFFFFF), static_cast<int>(0xFFFFFFFF), static_cast<int>(0xFFFFFFFF)};
const XMVECTORI32 g_XMMaskA8R8G8B8      = {static_cast<int>(0x00FF0000), static_cast<int>(0x0000FF00), static_cast<int>(0x000000FF), static_cast<int>(0xFF000000)};
const XMVECTORI32 g_XMFlipA8R8G8B8      = {static_cast<int>(0x00000000), static_cast<int>(0x00000000), static_cast<int>(0x00000000), static_cast<int>(0x80000000)};
...
const XMVECTORI32 g_XMMaskA2B10G10R10   = {static_cast<int>(0x000003FF), static_cast<int>(0x000FFC00), static_cast<int>(0x3FF00000), static_cast<int>(0xC0000000)};
const XMVECTORI32 g_XMFlipA2B10G10R10   = {static_cast<int>(0x00000200), static_cast<int>(0x00080000), static_cast<int>(0x20000000), static_cast<int>(0x80000000)};
...
const XMVECTORI32 g_XMMaskX16Y16        = {static_cast<int>(0x0000FFFF), static_cast<int>(0xFFFF0000), static_cast<int>(0x00000000), static_cast<int>(0x00000000)};
...
const XMVECTORI32 g_XMMaskX16Y16Z16W16  = {static_cast<int>(0x0000FFFF), static_cast<int>(0x0000FFFF), static_cast<int>(0xFFFF0000), static_cast<int>(0xFFFF0000)};
...
const XMVECTORI32 g_XMSelect0101        = {static_cast<int>(XM_SELECT_0), static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_0), static_cast<int>(XM_SELECT_1)};
const XMVECTORI32 g_XMSelect1010        = {static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_0), static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_0)};
const XMVECTORI32 g_XMOneHalfMinusEpsilon = { 0x3EFFFFFD, 0x3EFFFFFD, 0x3EFFFFFD, 0x3EFFFFFD};
const XMVECTORI32 g_XMSelect1000        = {static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_0), static_cast<int>(XM_SELECT_0), static_cast<int>(XM_SELECT_0)};
const XMVECTORI32 g_XMSelect1100        = {static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_0), static_cast<int>(XM_SELECT_0)};
const XMVECTORI32 g_XMSelect1110        = {static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_1), static_cast<int>(XM_SELECT_0)};
const XMVECTORI32 g_XMSwizzleXYXY       = {static_cast<int>(XM_PERMUTE_0X), static_cast<int>(XM_PERMUTE_0Y), static_cast<int>(XM_PERMUTE_0X), static_cast<int>(XM_PERMUTE_0Y)};
const XMVECTORI32 g_XMSwizzleXYZX       = {static_cast<int>(XM_PERMUTE_0X), static_cast<int>(XM_PERMUTE_0Y), static_cast<int>(XM_PERMUTE_0Z), static_cast<int>(XM_PERMUTE_0X)};
const XMVECTORI32 g_XMSwizzleYXZW       = {static_cast<int>(XM_PERMUTE_0Y), static_cast<int>(XM_PERMUTE_0X), static_cast<int>(XM_PERMUTE_0Z), static_cast<int>(XM_PERMUTE_0W)};
const XMVECTORI32 g_XMSwizzleYZXW       = {static_cast<int>(XM_PERMUTE_0Y), static_cast<int>(XM_PERMUTE_0Z), static_cast<int>(XM_PERMUTE_0X), static_cast<int>(XM_PERMUTE_0W)};
const XMVECTORI32 g_XMSwizzleZXYW       = {static_cast<int>(XM_PERMUTE_0Z), static_cast<int>(XM_PERMUTE_0X), static_cast<int>(XM_PERMUTE_0Y), static_cast<int>(XM_PERMUTE_0W)};
const XMVECTORI32 g_XMPermute0X0Y1X1Y   = {static_cast<int>(XM_PERMUTE_0X), static_cast<int>(XM_PERMUTE_0Y), static_cast<int>(XM_PERMUTE_1X), static_cast<int>(XM_PERMUTE_1Y)};
const XMVECTORI32 g_XMPermute0Z0W1Z1W   = {static_cast<int>(XM_PERMUTE_0Z), static_cast<int>(XM_PERMUTE_0W), static_cast<int>(XM_PERMUTE_1Z), static_cast<int>(XM_PERMUTE_1W)};
...
const XMVECTORI32 g_XMFlipY             = {0,static_cast<int>(0x80000000),0,0};
const XMVECTORI32 g_XMFlipZ             = {0,0,static_cast<int>(0x80000000),0};
const XMVECTORI32 g_XMFlipW             = {0,0,0,static_cast<int>(0x80000000)};
const XMVECTORI32 g_XMFlipYZ            = {0,static_cast<int>(0x80000000),static_cast<int>(0x80000000),0};
const XMVECTORI32 g_XMFlipZW            = {0,0,static_cast<int>(0x80000000),static_cast<int>(0x80000000)};
const XMVECTORI32 g_XMFlipYW            = {0,static_cast<int>(0x80000000),0,static_cast<int>(0x80000000)};
...
const XMVECTORI32 g_XMMaskIco4          = {0xFFFFF,static_cast<int>(0xFFFFF000),0xFFFFF,static_cast<int>(0xF0000000)};
const XMVECTORI32 g_XMXorXIco4          = {0x80000,0,0x80000,static_cast<int>(0x80000000)};
...
const XMVECTORI32 g_XMMaskByte4         = {0xFF,0xFF00,0xFF0000,static_cast<int>(0xFF000000)};
...
_XMMATRIX::_XMMATRIX(const _XMMATRIX& M)
:   _11( M._11 ),
    _12( M._12 ),
    _13( M._13 ),
    _14( M._14 ),
